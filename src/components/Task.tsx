...
export default function Task({
  ...
  return (
    <li
      key={task.id}
      className="flex flex-col md:flex-row justify-between items-center bg-[#183075] rounded py-2 px-4 mb-2 text-white"
    >
      {isEditing === task.id ? (
        <>
          <input
            ...
            className="py-2 px-4 w-full md:w-auto rounded-full bg-[#183075] text-white mb-2 md:mb-0"
          />
          <button
